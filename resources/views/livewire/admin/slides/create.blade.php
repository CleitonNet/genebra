<div>
    <form wire:submit="save" class="grid p-8 border-2 rounded-lg backdrop-blur-sm bg-azul/10" style="box-shadow: 0 0 2px 1px rgba(0,0,0,0.5)" enctype="multipart/form-data">
