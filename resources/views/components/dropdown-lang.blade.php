...
$classes = ($active ?? false)
            ...
            : 'text-black/70 hover:text-azul/90 focus:outline-none focus:text-back';

@endphp

<div class="relative inline-flex items-center {{ $classes }} px-1 font-bold leading-5 transition duration-150 ease-in-out" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            class="absolute z-50 mt-2 top-[40px] w-32 rounded-md shadow-lg {{ $alignmentClasses }}"
            style="display: none;"
            @click="open = false">
